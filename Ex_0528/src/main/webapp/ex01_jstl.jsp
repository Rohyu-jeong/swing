...
<body>
<!-- JSTL
프로그래밍 언어에서 제공하는 변수 선언, 조건문, 반복문 등의 로직을 태그로 구사할 수 있게 해주는 라이브러리입니다. -->

<c:set var="num" value="100"/>
<!-- set을 이용해 선언한 변수는 pageContext영역에 세팅이 되서 el 표현식으로 사용할 수 있다. -->
${num}
<br>
<c:if test="${n eq 10}">
	참
...
<!-- var : 값을 담을 변수
	...
	step: 증가량 -->
<c:forEach var="i" begint="1" end="5" step="1">
